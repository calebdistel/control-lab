...
## Simulation: flywheel velocity controller

<RobotSimEditor
  client:load
  type="flywheel"
  starterCode={`public class ShooterController {
    static double kS  = 0.10;   // V — static friction
    static double kV  = 0.0020; // V / RPM — back-EMF
    static double kP  = 0.003;  // V / RPM — PID correction
    static double setpointRPM = 4500.0;
    ...
    public static void periodic() {
        ...
        SmartDashboard.putNumber("voltage",  total);
    }
}`}
  hint="Try adjusting kV first — if the flywheel settles below the setpoint, increase kV. Then adjust kP to control how fast it corrects after a disturbance. The kS constant handles static friction at low voltages."
/>
