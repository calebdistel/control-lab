...
<CodeEditor
  ...
  starterCode={`public class Main {
    public static void main(String[] args) {
        ...
        // Use a loop — don't write 5 separate println calls

    }
}`}
  testCases={[
    { label: "Countdown from 5 to 1 then GO!", expected: "5\n4\n3\n2\n1\nGO!" },
  ]}
  hint="Start i at 5, loop while i >= 1, decrement each iteration. Print 'GO!' after the loop."
/>
