...
<CodeEditor
  ...
  starterCode={`public class Main {
    static double deadband(double input, double threshold) {
        // Return 0.0 if |input| < threshold, else return input
        return input; // fix this
    }

    public static void main(String[] args) {
        System.out.println(deadband(0.04, 0.1));   // noise — return 0.0
        System.out.println(deadband(-0.03, 0.1));  // noise — return 0.0
        System.out.println(deadband(0.6, 0.1));    // real input — return 0.6
        System.out.println(deadband(-0.9, 0.1));   // real input — return -0.9
    }
}`}
  testCases={[
    { label: "Small values zeroed, large values pass through", expected: "0.0\n0.0\n0.6\n-0.9" },
  ]}
  hint="Math.abs(input) gives you the absolute value. Compare that to threshold."
/>
